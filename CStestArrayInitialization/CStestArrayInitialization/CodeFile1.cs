// testArrayInitialization.cs (c) 2006 by Charles Petzoid
...
class TestArrayInitialization
{
    ...
    static int[] daysCumulativeDays = { 0, 31, 59, 90, 120, 151, 181, 212, 243, 273, 304, 334 };
    ...
    {
        int[] daysCumulative1 = { 0, 31, 59, 90, 120, 151, 181, 212, 243, 273, 304, 334 };
